...
from leo_controller_interface_package import TurnExploreOn
from leo_controller_interface_package import TurnExploreOff
...
class ControllerNode(Node):
    ...
    def __init__(self):
        ...
        self.service_client_robot_explore_on = self.create_client(
             ...
             srv_name='/turn_exploration_on')
        
        self.service_client_robot_explore_on = self.create_client(
             srv_type=TurnExploreOff,
             srv_name='/turn_exploration_off')
        
        
        timer_period: float = 1
        self.timer = self.create_timer(
            timer_period_sec=timer_period,
            callback=self.main_loop_callback)
