...
class PromoScan(Node):
    ...
    def timer_callback(self):
        ...
        request.config = 3  # Case 3: scan for the promo video
...
def main(args=None) -> None:
    """Entry point for the PromoScan service client."""
    try:
        rclpy.init(args=args)
        promo_scan = PromoScan()
        rclpy.spin(promo_scan)
