...
class DemoDrop(Node):
    """A ROS2 ControllerSet service client that requests drop block."""

    def __init__(self):
        super().__init__("demo_drop")
    ...
    def timer_callback(self):
        ...
        request.config = 7  # Case 7: drop block
...
def main(args=None) -> None:
    """Entry point for the DemoDrop service client."""
    try:
        rclpy.init(args=args)
        demo_drop = DemoDrop()
        rclpy.spin(demo_drop)
