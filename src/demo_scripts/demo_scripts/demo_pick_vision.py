...
class DemoPickVision(Node):
    ...
    def timer_callback(self):
        ...
        request.config = 6  # Case 6: pick block (with vision)
...
def main(args=None) -> None:
    """Entry point for the DemoPickVision service client."""
    try:
        rclpy.init(args=args)
        demo_pick_vision = DemoPickVision()
        rclpy.spin(demo_pick_vision)
