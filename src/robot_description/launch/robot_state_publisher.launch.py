...
def process_ros2_controllers_config(context):
    ...
    pkg_share_moveit = FindPackageShare(package='mycobot_280pi_moveit_config').find('mycobot_280pi_moveit_config')
...
def generate_launch_description():
    ...
    default_urdf_model_path = PathJoinSubstitution(
        [pkg_share_description, 'urdf', 'mycobot_280pi', urdf_filename])
